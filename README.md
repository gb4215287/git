...
###### 配置设置
```
#git config user.name “iranw”           //配置变量0669910(本git目录-针对本目录)
=======
#git config user.name “iranw”           //配置变量266(本git目录-针对本目录)
#git config user.email “wang_wenguan@yeah.net” //配置变量 
#git config --global user.name “iranw”  //配置变量288(用户目录-针对本用户)
